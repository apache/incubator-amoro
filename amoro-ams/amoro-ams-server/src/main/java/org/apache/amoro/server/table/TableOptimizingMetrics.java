...
public class TableOptimizingMetrics {
  ...
  public static final MetricDefine TABLE_LAST_MINOR_OPTIMIZING_INTERVAL =
      defineGauge("table_last_minor_optimizing_duration_mills")
          .withDescription("Duration in milliseconds after last minor optimizing")
          .withTags("catalog", "database", "table")
          .build();

  public static final MetricDefine TABLE_LAST_MAJOR_OPTIMIZING_INTERVAL =
      defineGauge("table_last_major_optimizing_duration_mills")
          .withDescription("Duration in milliseconds after last major optimizing")
          .withTags("catalog", "database", "table")
          .build();

  public static final MetricDefine TABLE_LAST_FULL_OPTIMIZING_DURATION =
      defineGauge("table_last_full_optimizing_duration_mills")
  ...
  public static final MetricDefine TABLE_OPTIMIZING_REFRESHED_SNAPSHOT_SLIDE_INTERVAL =
      defineGauge("table_optimizing_refreshed_snapshot_slide_interval_mills")
          .withDescription(
  ...
  public void register(MetricRegistry registry) {
    if (globalRegistry == null) {
      ...
      registerMetric(
          registry,
          TABLE_LAST_MINOR_OPTIMIZING_INTERVAL,
          new LastOptimizingDurationGauge(OptimizingType.MINOR));
      registerMetric(
          registry,
          TABLE_LAST_MAJOR_OPTIMIZING_INTERVAL,
          new LastOptimizingDurationGauge(OptimizingType.MAJOR));
      registerMetric(
          registry,
          TABLE_LAST_FULL_OPTIMIZING_DURATION,
      ...
      registerMetric(
          registry,
          TABLE_OPTIMIZING_REFRESHED_SNAPSHOT_SLIDE_INTERVAL,
          (Gauge<Long>)
              () -> {
